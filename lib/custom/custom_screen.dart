...
class _CustomScreenState extends State<CustomScreen> {
  ...
  void dispose() {
    super.dispose();
    if (listTik.isNotEmpty && stringImageForSaveAndroid.isNotEmpty) {
      var data = GetIt.I.get<Box<FitnosModel>>();
      data.put(
        '$id',
        FitnosModel(
            fitnosKey: '$id',
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      canPop: listTik.isNotEmpty && stringImageForSaveAndroid.isNotEmpty,
      child: Scaffold(
